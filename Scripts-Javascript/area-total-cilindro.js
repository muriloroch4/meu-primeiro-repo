...
const raioBaseCilindro = 3;
const alturaCilindro = 1;

const areaTotal = 2 * (raioBaseCilindro * (raioBaseCilindro + alturaCilindro));
console.log(`A area total do cilindro é de aproximadamente ${areaTotal}pi`);