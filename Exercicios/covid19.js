/* # Exercício 07 ## Casos de COVID-19
...
P será a quantidade de pessoas infectadas após decorrido o tempo t. Imprima na tela o valor de P para os dados informados 
acima.
...
Isso significa que, após 7 dias, o total de pessoas infectadas será de 4000, uma vez que inicialmente existiam 1000 
pessoas infectadas.*/

const populacaoInicialInfectados = 1000;
const raioTransmissaoPaciente = 4;
const tempoPercorrido = 100;

const resultado = Math.round(populacaoInicialInfectados * (4**(tempoPercorrido/7)));
console.log(`Após ${tempoPercorrido} dias, haverão ${resultado} pessoas infectadas`); 
