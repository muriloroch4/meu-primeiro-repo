...
#### Exemplo:
\
Se um capital de R$ 1000,00 é aplicado durante 5 meses no sistema de juros compostos sob uma taxa mensal fixa de 12,5%, 
qual será o valor do montante?
...
const taxaDeJuros = 12.5;
const tempo = 5;

const montante = capital * (1 + (taxaDeJuros/100)) ** tempo;
